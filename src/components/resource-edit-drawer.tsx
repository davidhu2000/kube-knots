      ...
      description={
        <div className="flex w-full gap-8 p-2">
          ...
          <button
            ...
            className="rounded-md border bg-gray-100 px-4 py-2 text-gray-900 shadow-md hover:bg-gray-200 dark:border-gray-700 dark:bg-blue-800 dark:text-gray-100 hover:dark:bg-blue-900"
          >
            Save
          </button>
        </div>
