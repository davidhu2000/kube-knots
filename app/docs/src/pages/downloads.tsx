...
export function DownloadButton({ platform }: { platform: Platform }): JSX.Element {
  return (
    <a
      ...
      className="group relative flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-blue-500/80 px-12 py-2 shadow hover:bg-blue-500 hover:text-black hover:no-underline dark:bg-blue-600/80 dark:hover:bg-blue-600 dark:hover:text-white"
    >
