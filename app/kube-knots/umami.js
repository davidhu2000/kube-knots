  ...
  !(function (t) {
    ...
    if (d) {
      var v,
        ...
        j = (S ? S.replace(/\/$/, "") : d.src.split("/").slice(0, -1).join("/")) + "/api/send",
        x = n + "x" + r,
        O = /^umami--([a-z]+)--([\w]+[\w-]*)$/,
        K = "[class*='umami--']",
        L = {},
        ...
        P = c.referrer,
        $ = function () {
          return { website: w, hostname: s, screen: x, language: a, url: D };
        },
        _ = function (t, e) {
          var n;
          if (!m())
            return fetch(j, {
              method: "POST",
              body: JSON.stringify({ type: t, payload: e }),
              headers: p(
        ...
        q = function (t, e, n) {
          return (
            ...
            void 0 === e && (e = P),
            void 0 === n && (n = w),
            _("pageview", p($(), { website: n, url: t, referrer: e }))
          );
        },
        z = function (t, e, n, r) {
          return (
            void 0 === n && (n = D),
            void 0 === r && (r = w),
            _("event", p($(), { website: r, url: n, event_name: t, event_data: e }))
          );
        },
        C = function (t) {
        ...
        J = function (t, e, n) {
          if (n) {
            P = D;
            var r = n.toString();
            (D = "http" === r.substring(0, 4) ? "/" + r.split("/").splice(3).join("/") : r) !== P &&
              q();
          }
        };
      if (!t.umami) {
